import sys
import os
from PyQt5.QtWidgets import QApplication, QMainWindow, QPushButton, QVBoxLayout, QWidget, QHBoxLayout, QLabel, QLineEdit, QTextEdit, QTabWidget, QMenuBar, QCalendarWidget
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.tab3 = CalendarWidget()  # Calendar widget for the third tab
    ...
    def create_menu(self):
        ...
        self.add_menu_button(menu_layout, 'ΗΜΕΡΟΛΟΓΙΟ ΡΑΝΤΕΒΟΥ', 2)  # Calendar tab
        self.add_menu_button(menu_layout, 'ΣΥΝΤΑΓΟΓΡΑΦΗΣΗ', 3)
        self.add_menu_button(menu_layout, 'ΑΤΖΕΝΤΑ ΑΣΘΕΝΩΝ', 4)
